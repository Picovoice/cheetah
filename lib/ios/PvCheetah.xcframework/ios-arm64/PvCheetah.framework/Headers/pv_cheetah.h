...
typedef struct {
    ...
    int32_t num_phoneme; /** Number of phonemes in the word. */
    float acoustic_cost; /** The cost value associated with the acoustic model. */
    float lm_cost; /** The cost value associated with the language model. */
...
PV_API pv_status_t pv_cheetah_init(
        ...
        bool enable_text_normalization,
        pv_cheetah_t **object);
